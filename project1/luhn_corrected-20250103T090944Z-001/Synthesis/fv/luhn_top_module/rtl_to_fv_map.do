...
# Generated on: Fri Jan 03 19:19:30 IST 2025 (Fri Jan 03 13:49:30 UTC 2025)
...
set logfile fv/luhn_top_module/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/luhn_top_module -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/vlsi24/c2s/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/vlsi24/c2s/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /home/vlsi24/scl_pdk/stdlib/fs120/liberty/lib_flow_ff -library -both
read_library -liberty -both \
    /home/vlsi24/scl_pdk/stdlib/fs120/liberty/lib_flow_ff/tsl18fs120_scl_ff.lib
...
add_search_path /home/vlsi24/Desktop/EC1062DICDlab/project1/luhn_corrected-20250103T090944Z-001/luhn_corrected -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/vlsi24/Desktop/EC1062DICDlab/project1/luhn_corrected-20250103T090944Z-001/luhn_corrected/luhn_topmodule.v /home/vlsi24/Desktop/EC1062DICDlab/project1/luhn_corrected-20250103T090944Z-001/luhn_corrected/luhn_datapath_corrected.v /home/vlsi24/Desktop/EC1062DICDlab/project1/luhn_corrected-20250103T090944Z-001/luhn_corrected/luhn_controller_corrected.v
elaborate_design -golden -root {luhn_top_module} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/luhn_top_module/fv_map.v.gz
elaborate_design -revised -root {luhn_top_module}
...
#add_name_alias fv/luhn_top_module/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.luhn_top_module.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.luhn_top_module.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.luhn_top_module.rtl.fv_map.rpt
